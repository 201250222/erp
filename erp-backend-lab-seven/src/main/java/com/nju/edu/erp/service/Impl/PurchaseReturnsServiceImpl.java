...
import com.nju.edu.erp.service.sheetService.PurchaseReturnsService;
...
public class PurchaseReturnsServiceImpl implements PurchaseReturnsService {
    ...
    @Override
    @Transactional
    public void makeSheet(UserVO userVO, SheetVO purchaseReturnsSheetVO) {
        ...
        purchaseReturnsSheetPO.setSupplier(purchaseSheetDao.findOneById(purchaseReturnsSheetPO.getPurchaseSheetId()).getSupplier());
        ...
        for(PurchaseReturnsSheetContentVO content : ((PurchaseReturnsSheetVO) purchaseReturnsSheetVO).getPurchaseReturnsSheetContent()) {
    ...
    public List<SheetVO> getSheetByState(BaseEnum state) {
        ...
        if(state == null) {
            ...
            all = purchaseReturnsSheetDao.findAllByState((PurchaseReturnsSheetState) state);
        }
    ...
    @Override
    @Transactional
    public void approval(String purchaseReturnsSheetId, BaseEnum state) {
        ...
        if(state.equals(PurchaseReturnsSheetState.FAILURE)) {
            ...
            int effectLines = purchaseReturnsSheetDao.updateState(purchaseReturnsSheetId, (PurchaseReturnsSheetState) state);
            ...
            int effectLines = purchaseReturnsSheetDao.updateStateV2(purchaseReturnsSheetId, prevState, (PurchaseReturnsSheetState) state);
            if(effectLines == 0) throw new RuntimeException("状态更新失败");
            if(state.equals(PurchaseReturnsSheetState.SUCCESS)) {
