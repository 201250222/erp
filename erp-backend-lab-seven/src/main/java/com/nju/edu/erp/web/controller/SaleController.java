...
public class SaleController {
    ...
    /**
     * 查看销售明细表
     * @param saleDetailParamsVO 封装需要使用的参数，不使用的置为null
     * @return 销售明细
     */
    @PostMapping("/detail")
    @Authorized (roles = {Role.FINANCIAL_STAFF, Role.ADMIN, Role.GM})
    public Response showSaleDetail(@RequestBody SaleDetailParamsVO saleDetailParamsVO){
        return Response.buildSuccess(saleService.showSaleDetail(saleDetailParamsVO));
    }
